...
class DB:
    def __init__(self):
        ...
        if self.run_query("select * from students") == []:
            self.run_query("INSERT INTO students(id, first_name, last_name, mail, phone, dob, gender, address_1, address_2, city, state, zip, country) VALUES(0, :f, :l, :m, :p, :d, :g, :a1, :a2, :c, :s, :z, :co)",
